...
dictionary of arguments that specify various aspects of the project.
...
- long_description_content_type`: The type of content in the long description (e.g., text
or markdown).
- url`: The URL of the project's homepage.
- packages`: A list of packages that should be included in the distribution.
- install_requires`: A list of dependencies that should be installed when the project is
installed.
